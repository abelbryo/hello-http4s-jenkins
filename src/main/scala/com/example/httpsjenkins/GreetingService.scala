...
object GreetingService {
  implicit def apply[F[_]](
      implicit ev: GreetingService[F]
  ): GreetingService[F] = ev
  ...
  object Greeting {
    ...
    implicit val greetingEncoder: Encoder[Greeting] = Encoder[Greeting] { a =>
      Json.obj(
    ...
    implicit def greetingDecoder: Decoder[Greeting] = Decoder[Greeting] { c =>
      for {
    ...
    implicit def greetingEntityEncoder[F[_]: Applicative]
        : EntityEncoder[F, Greeting] = jsonEncoderOf[F, Greeting]
  }
